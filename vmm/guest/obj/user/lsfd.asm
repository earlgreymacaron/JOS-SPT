...
argstart(int *argc, char **argv, struct Argstate *args)
{
  ...
  801c89:	48 b8 33 4d 80 00 00 	movabs $0x804d33,%rax
  801c90:	00 00 00 
...
argnextvalue(struct Argstate *args)
{
  ...
  801e85:	48 bb 33 4d 80 00 00 	movabs $0x804d33,%rbx
  801e8c:	00 00 00 
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  802aac:	00 00 00 
  802aaf:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  802ad9:	48 b9 dd 4d 80 00 00 	movabs $0x804ddd,%rcx
  802ae0:	00 00 00 
  802ae3:	48 ba bd 4d 80 00 00 	movabs $0x804dbd,%rdx
  802aea:	00 00 00 
  802aed:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  802bf1:	00 00 00 
  802bf4:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  802dc3:	48 bf e9 4d 80 00 00 	movabs $0x804de9,%rdi
  802dca:	00 00 00 
  ...
  802e0f:	48 bf ff 4d 80 00 00 	movabs $0x804dff,%rdi
  802e16:	00 00 00 
  ...
  802e74:	48 bf 19 4e 80 00 00 	movabs $0x804e19,%rdi
  802e7b:	00 00 00 
  ...
  802ef1:	48 bf 2c 4e 80 00 00 	movabs $0x804e2c,%rdi
  802ef8:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8035b5:	48 be 47 4e 80 00 00 	movabs $0x804e47,%rsi
  8035bc:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  803904:	48 b9 4e 4e 80 00 00 	movabs $0x804e4e,%rcx
  80390b:	00 00 00 
  80390e:	48 ba 63 4e 80 00 00 	movabs $0x804e63,%rdx
  803915:	00 00 00 
  803918:	be 62 00 00 00       	mov    $0x62,%esi
  80391d:	48 bf 78 4e 80 00 00 	movabs $0x804e78,%rdi
  803924:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80398e:	48 b9 84 4e 80 00 00 	movabs $0x804e84,%rcx
  803995:	00 00 00 
  803998:	48 ba 63 4e 80 00 00 	movabs $0x804e63,%rdx
  80399f:	00 00 00 
  8039a2:	be 6d 00 00 00       	mov    $0x6d,%esi
  8039a7:	48 bf 78 4e 80 00 00 	movabs $0x804e78,%rdi
  8039ae:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  803d08:	48 bf 95 4e 80 00 00 	movabs $0x804e95,%rdi
  803d0f:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803f8c:	48 be a8 4e 80 00 00 	movabs $0x804ea8,%rsi
  803f93:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8042c8:	48 be b4 4e 80 00 00 	movabs $0x804eb4,%rsi
  8042cf:	00 00 00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8043a2:	48 bf c0 4e 80 00 00 	movabs $0x804ec0,%rdi
  8043a9:	00 00 00 
  ...
  8043dc:	ff d0                	callq  *%rax
	cprintf("\n");
  8043de:	48 bf e3 4e 80 00 00 	movabs $0x804ee3,%rdi
  8043e5:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804526:	48 ba e5 4e 80 00 00 	movabs $0x804ee5,%rdx
  80452d:	00 00 00 
  804530:	be 47 00 00 00       	mov    $0x47,%esi
  804535:	48 bf fb 4e 80 00 00 	movabs $0x804efb,%rdi
  80453c:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804697:	48 ba e5 4e 80 00 00 	movabs $0x804ee5,%rdx
  80469e:	00 00 00 
  8046a1:	be 79 00 00 00       	mov    $0x79,%esi
  8046a6:	48 bf fb 4e 80 00 00 	movabs $0x804efb,%rdi
  8046ad:	00 00 00 
