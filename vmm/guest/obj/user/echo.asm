...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801aee:	00 00 00 
  801af1:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  801b1b:	48 b9 65 42 80 00 00 	movabs $0x804265,%rcx
  801b22:	00 00 00 
  801b25:	48 ba 45 42 80 00 00 	movabs $0x804245,%rdx
  801b2c:	00 00 00 
  801b2f:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801c33:	00 00 00 
  801c36:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  801e05:	48 bf 71 42 80 00 00 	movabs $0x804271,%rdi
  801e0c:	00 00 00 
  ...
  801e51:	48 bf 87 42 80 00 00 	movabs $0x804287,%rdi
  801e58:	00 00 00 
  ...
  801eb6:	48 bf a1 42 80 00 00 	movabs $0x8042a1,%rdi
  801ebd:	00 00 00 
  ...
  801f33:	48 bf b4 42 80 00 00 	movabs $0x8042b4,%rdi
  801f3a:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8022f3:	48 be cf 42 80 00 00 	movabs $0x8042cf,%rsi
  8022fa:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  802642:	48 b9 d6 42 80 00 00 	movabs $0x8042d6,%rcx
  802649:	00 00 00 
  80264c:	48 ba eb 42 80 00 00 	movabs $0x8042eb,%rdx
  802653:	00 00 00 
  802656:	be 62 00 00 00       	mov    $0x62,%esi
  80265b:	48 bf 00 43 80 00 00 	movabs $0x804300,%rdi
  802662:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8026cc:	48 b9 0c 43 80 00 00 	movabs $0x80430c,%rcx
  8026d3:	00 00 00 
  8026d6:	48 ba eb 42 80 00 00 	movabs $0x8042eb,%rdx
  8026dd:	00 00 00 
  8026e0:	be 6d 00 00 00       	mov    $0x6d,%esi
  8026e5:	48 bf 00 43 80 00 00 	movabs $0x804300,%rdi
  8026ec:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  802a46:	48 bf 1d 43 80 00 00 	movabs $0x80431d,%rdi
  802a4d:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802cca:	48 be 30 43 80 00 00 	movabs $0x804330,%rsi
  802cd1:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803006:	48 be 3c 43 80 00 00 	movabs $0x80433c,%rsi
  80300d:	00 00 00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8030e0:	48 bf 48 43 80 00 00 	movabs $0x804348,%rdi
  8030e7:	00 00 00 
  ...
  80311a:	ff d0                	callq  *%rax
	cprintf("\n");
  80311c:	48 bf 6b 43 80 00 00 	movabs $0x80436b,%rdi
  803123:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  803ed9:	00 00 00 
  803edc:	be 47 00 00 00       	mov    $0x47,%esi
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80404a:	00 00 00 
  80404d:	be 79 00 00 00       	mov    $0x79,%esi
