...
pgfault(struct UTrapframe *utf)
{
  ...
  801d04:	00 00 00 
  801d07:	be 28 00 00 00       	mov    $0x28,%esi
  ...
  801d9e:	00 00 00 
  801da1:	be 2d 00 00 00       	mov    $0x2d,%esi
  ...
  801ded:	00 00 00 
  801df0:	be 31 00 00 00       	mov    $0x31,%esi
...
duppage(envid_t envid, unsigned pn)
{
  ...
  801ea0:	00 00 00 
  801ea3:	be 50 00 00 00       	mov    $0x50,%esi
  ...
  801f08:	00 00 00 
  801f0b:	be 64 00 00 00       	mov    $0x64,%esi
  ...
  801f6b:	00 00 00 
  801f6e:	be 66 00 00 00       	mov    $0x66,%esi
...
sys_exofork(void)
{
  ...
  802102:	00 00 00 
  802105:	be 9e 00 00 00       	mov    $0x9e,%esi
  ...
  802163:	00 00 00 
  802166:	be a2 00 00 00       	mov    $0xa2,%esi
  ...
  8021b2:	00 00 00 
  8021b5:	be a7 00 00 00       	mov    $0xa7,%esi
...
sfork(void)
{
  ...
  8021e6:	00 00 00 
  8021e9:	be b1 00 00 00       	mov    $0xb1,%esi
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  802d84:	00 00 00 
  802d87:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  802db1:	48 b9 9d 4f 80 00 00 	movabs $0x804f9d,%rcx
  802db8:	00 00 00 
  802dbb:	48 ba 7d 4f 80 00 00 	movabs $0x804f7d,%rdx
  802dc2:	00 00 00 
  802dc5:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  802ec9:	00 00 00 
  802ecc:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  80309b:	48 bf a9 4f 80 00 00 	movabs $0x804fa9,%rdi
  8030a2:	00 00 00 
  ...
  8030e7:	48 bf bf 4f 80 00 00 	movabs $0x804fbf,%rdi
  8030ee:	00 00 00 
  ...
  80314c:	48 bf d9 4f 80 00 00 	movabs $0x804fd9,%rdi
  803153:	00 00 00 
  ...
  8031c9:	48 bf ec 4f 80 00 00 	movabs $0x804fec,%rdi
  8031d0:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803589:	48 be 07 50 80 00 00 	movabs $0x805007,%rsi
  803590:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8038d8:	48 b9 0e 50 80 00 00 	movabs $0x80500e,%rcx
  8038df:	00 00 00 
  8038e2:	48 ba 23 50 80 00 00 	movabs $0x805023,%rdx
  8038e9:	00 00 00 
  8038ec:	be 62 00 00 00       	mov    $0x62,%esi
  8038f1:	48 bf 38 50 80 00 00 	movabs $0x805038,%rdi
  8038f8:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  803962:	48 b9 44 50 80 00 00 	movabs $0x805044,%rcx
  803969:	00 00 00 
  80396c:	48 ba 23 50 80 00 00 	movabs $0x805023,%rdx
  803973:	00 00 00 
  803976:	be 6d 00 00 00       	mov    $0x6d,%esi
  80397b:	48 bf 38 50 80 00 00 	movabs $0x805038,%rdi
  803982:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  803cdc:	48 bf 55 50 80 00 00 	movabs $0x805055,%rdi
  803ce3:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803f60:	48 be 68 50 80 00 00 	movabs $0x805068,%rsi
  803f67:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80429c:	48 be 74 50 80 00 00 	movabs $0x805074,%rsi
  8042a3:	00 00 00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  804376:	48 bf 80 50 80 00 00 	movabs $0x805080,%rdi
  80437d:	00 00 00 
  ...
  8043b0:	ff d0                	callq  *%rax
	cprintf("\n");
  8043b2:	48 bf a3 50 80 00 00 	movabs $0x8050a3,%rdi
  8043b9:	00 00 00 
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  804417:	48 ba a8 50 80 00 00 	movabs $0x8050a8,%rdx
  80441e:	00 00 00 
  804421:	be 22 00 00 00       	mov    $0x22,%esi
  804426:	48 bf c7 50 80 00 00 	movabs $0x8050c7,%rdi
  80442d:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804622:	48 ba d5 50 80 00 00 	movabs $0x8050d5,%rdx
  804629:	00 00 00 
  80462c:	be 47 00 00 00       	mov    $0x47,%esi
  804631:	48 bf eb 50 80 00 00 	movabs $0x8050eb,%rdi
  804638:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804793:	48 ba d5 50 80 00 00 	movabs $0x8050d5,%rdx
  80479a:	00 00 00 
  80479d:	be 79 00 00 00       	mov    $0x79,%esi
  8047a2:	48 bf eb 50 80 00 00 	movabs $0x8050eb,%rdi
  8047a9:	00 00 00 
