...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  802a95:	00 00 00 
  802a98:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  802ac2:	48 b9 5d 4a 80 00 00 	movabs $0x804a5d,%rcx
  802ac9:	00 00 00 
  802acc:	48 ba 3d 4a 80 00 00 	movabs $0x804a3d,%rdx
  802ad3:	00 00 00 
  802ad6:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  802bda:	00 00 00 
  802bdd:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  802dac:	48 bf 69 4a 80 00 00 	movabs $0x804a69,%rdi
  802db3:	00 00 00 
  ...
  802df8:	48 bf 7f 4a 80 00 00 	movabs $0x804a7f,%rdi
  802dff:	00 00 00 
  ...
  802e5d:	48 bf 99 4a 80 00 00 	movabs $0x804a99,%rdi
  802e64:	00 00 00 
  ...
  802eda:	48 bf ac 4a 80 00 00 	movabs $0x804aac,%rdi
  802ee1:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80329a:	48 be c7 4a 80 00 00 	movabs $0x804ac7,%rsi
  8032a1:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8035e9:	48 b9 ce 4a 80 00 00 	movabs $0x804ace,%rcx
  8035f0:	00 00 00 
  8035f3:	48 ba e3 4a 80 00 00 	movabs $0x804ae3,%rdx
  8035fa:	00 00 00 
  8035fd:	be 62 00 00 00       	mov    $0x62,%esi
  803602:	48 bf f8 4a 80 00 00 	movabs $0x804af8,%rdi
  803609:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  803673:	48 b9 04 4b 80 00 00 	movabs $0x804b04,%rcx
  80367a:	00 00 00 
  80367d:	48 ba e3 4a 80 00 00 	movabs $0x804ae3,%rdx
  803684:	00 00 00 
  803687:	be 6d 00 00 00       	mov    $0x6d,%esi
  80368c:	48 bf f8 4a 80 00 00 	movabs $0x804af8,%rdi
  803693:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8039ed:	48 bf 15 4b 80 00 00 	movabs $0x804b15,%rdi
  8039f4:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803c71:	48 be 28 4b 80 00 00 	movabs $0x804b28,%rsi
  803c78:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803fad:	48 be 34 4b 80 00 00 	movabs $0x804b34,%rsi
  803fb4:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8040f7:	48 ba 3b 4b 80 00 00 	movabs $0x804b3b,%rdx
  8040fe:	00 00 00 
  804101:	be 47 00 00 00       	mov    $0x47,%esi
  804106:	48 bf 51 4b 80 00 00 	movabs $0x804b51,%rdi
  80410d:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804268:	48 ba 3b 4b 80 00 00 	movabs $0x804b3b,%rdx
  80426f:	00 00 00 
  804272:	be 79 00 00 00       	mov    $0x79,%esi
  804277:	48 bf 51 4b 80 00 00 	movabs $0x804b51,%rdi
  80427e:	00 00 00 
