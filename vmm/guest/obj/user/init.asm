...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  802dc8:	00 00 00 
  802dcb:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  802df5:	48 b9 5d 57 80 00 00 	movabs $0x80575d,%rcx
  802dfc:	00 00 00 
  802dff:	48 ba 3d 57 80 00 00 	movabs $0x80573d,%rdx
  802e06:	00 00 00 
  802e09:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  802f0d:	00 00 00 
  802f10:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  8030df:	48 bf 69 57 80 00 00 	movabs $0x805769,%rdi
  8030e6:	00 00 00 
  ...
  80312b:	48 bf 7f 57 80 00 00 	movabs $0x80577f,%rdi
  803132:	00 00 00 
  ...
  803190:	48 bf 99 57 80 00 00 	movabs $0x805799,%rdi
  803197:	00 00 00 
  ...
  80320d:	48 bf ac 57 80 00 00 	movabs $0x8057ac,%rdi
  803214:	00 00 00 
...
error:
  ...
  80354c:	48 ba 04 58 80 00 00 	movabs $0x805804,%rdx
  803553:	00 00 00 
  ...
  80359b:	48 ba 1e 58 80 00 00 	movabs $0x80581e,%rdx
  8035a2:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  804510:	48 b9 d2 58 80 00 00 	movabs $0x8058d2,%rcx
  804517:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80488a:	48 bf e3 58 80 00 00 	movabs $0x8058e3,%rdi
  804891:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  804b0e:	48 be f6 58 80 00 00 	movabs $0x8058f6,%rsi
  804b15:	00 00 00 
...
wait(envid_t envid)
{
  ...
  804bc8:	48 b9 fd 58 80 00 00 	movabs $0x8058fd,%rcx
  804bcf:	00 00 00 
  804bd2:	48 ba 08 59 80 00 00 	movabs $0x805908,%rdx
  804bd9:	00 00 00 
  804bdc:	be 0a 00 00 00       	mov    $0xa,%esi
  804be1:	48 bf 1d 59 80 00 00 	movabs $0x80591d,%rdi
  804be8:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804d76:	48 ba 28 59 80 00 00 	movabs $0x805928,%rdx
  804d7d:	00 00 00 
  804d80:	be 47 00 00 00       	mov    $0x47,%esi
  804d85:	48 bf 3e 59 80 00 00 	movabs $0x80593e,%rdi
  804d8c:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804ee7:	48 ba 28 59 80 00 00 	movabs $0x805928,%rdx
  804eee:	00 00 00 
  804ef1:	be 79 00 00 00       	mov    $0x79,%esi
  804ef6:	48 bf 3e 59 80 00 00 	movabs $0x80593e,%rdi
  804efd:	00 00 00 
