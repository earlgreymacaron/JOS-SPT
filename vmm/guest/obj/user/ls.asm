...
lsdir(const char *path, const char *prefix)
{
  ...
  800174:	48 ba 56 4b 80 00 00 	movabs $0x804b56,%rdx
  80017b:	00 00 00 
  ...
  80021a:	48 ba 62 4b 80 00 00 	movabs $0x804b62,%rdx
  800221:	00 00 00 
...
argstart(int *argc, char **argv, struct Argstate *args)
{
  ...
  8020fb:	48 b8 13 51 80 00 00 	movabs $0x805113,%rax
  802102:	00 00 00 
...
argnextvalue(struct Argstate *args)
{
  ...
  8022f7:	48 bb 13 51 80 00 00 	movabs $0x805113,%rbx
  8022fe:	00 00 00 
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  802f1e:	00 00 00 
  802f21:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  802f4b:	48 b9 bd 51 80 00 00 	movabs $0x8051bd,%rcx
  802f52:	00 00 00 
  802f55:	48 ba 9d 51 80 00 00 	movabs $0x80519d,%rdx
  802f5c:	00 00 00 
  802f5f:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  803063:	00 00 00 
  803066:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  803235:	48 bf c9 51 80 00 00 	movabs $0x8051c9,%rdi
  80323c:	00 00 00 
  ...
  803281:	48 bf df 51 80 00 00 	movabs $0x8051df,%rdi
  803288:	00 00 00 
  ...
  8032e6:	48 bf f9 51 80 00 00 	movabs $0x8051f9,%rdi
  8032ed:	00 00 00 
  ...
  803363:	48 bf 0c 52 80 00 00 	movabs $0x80520c,%rdi
  80336a:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803a27:	48 be 27 52 80 00 00 	movabs $0x805227,%rsi
  803a2e:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  803d76:	48 b9 2e 52 80 00 00 	movabs $0x80522e,%rcx
  803d7d:	00 00 00 
  803d80:	48 ba 43 52 80 00 00 	movabs $0x805243,%rdx
  803d87:	00 00 00 
  803d8a:	be 62 00 00 00       	mov    $0x62,%esi
  803d8f:	48 bf 58 52 80 00 00 	movabs $0x805258,%rdi
  803d96:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  803e00:	48 b9 64 52 80 00 00 	movabs $0x805264,%rcx
  803e07:	00 00 00 
  803e0a:	48 ba 43 52 80 00 00 	movabs $0x805243,%rdx
  803e11:	00 00 00 
  803e14:	be 6d 00 00 00       	mov    $0x6d,%esi
  803e19:	48 bf 58 52 80 00 00 	movabs $0x805258,%rdi
  803e20:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80417a:	48 bf 75 52 80 00 00 	movabs $0x805275,%rdi
  804181:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8043fe:	48 be 88 52 80 00 00 	movabs $0x805288,%rsi
  804405:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80473a:	48 be 94 52 80 00 00 	movabs $0x805294,%rsi
  804741:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804884:	48 ba 9b 52 80 00 00 	movabs $0x80529b,%rdx
  80488b:	00 00 00 
  80488e:	be 47 00 00 00       	mov    $0x47,%esi
  804893:	48 bf b1 52 80 00 00 	movabs $0x8052b1,%rdi
  80489a:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8049f5:	48 ba 9b 52 80 00 00 	movabs $0x80529b,%rdx
  8049fc:	00 00 00 
  8049ff:	be 79 00 00 00       	mov    $0x79,%esi
  804a04:	48 bf b1 52 80 00 00 	movabs $0x8052b1,%rdi
  804a0b:	00 00 00 
