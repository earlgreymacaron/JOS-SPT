...
umain(int argc, char **argv)
{
  ...
  8000d3:	48 ba c0 4a 80 00 00 	movabs $0x804ac0,%rdx
  8000da:	00 00 00 
  ...
  800151:	48 bf c9 4a 80 00 00 	movabs $0x804ac9,%rdi
  800158:	00 00 00 
  ...
  800201:	48 bf cd 4a 80 00 00 	movabs $0x804acd,%rdi
  800208:	00 00 00 
  ...
  800248:	48 bf e9 4a 80 00 00 	movabs $0x804ae9,%rdi
  80024f:	00 00 00 
  ...
  800278:	48 ba 00 4b 80 00 00 	movabs $0x804b00,%rdx
  80027f:	00 00 00 
  ...
  8002c8:	48 ba 2a 4b 80 00 00 	movabs $0x804b2a,%rdx
  8002cf:	00 00 00 
  ...
  800306:	48 bf 42 4b 80 00 00 	movabs $0x804b42,%rdi
  80030d:	00 00 00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800483:	48 bf 60 4b 80 00 00 	movabs $0x804b60,%rdi
  80048a:	00 00 00 
  ...
  8004bd:	ff d0                	callq  *%rax
	cprintf("\n");
  8004bf:	48 bf 83 4b 80 00 00 	movabs $0x804b83,%rdi
  8004c6:	00 00 00 
...
pgfault(struct UTrapframe *utf)
{
  ...
  801fd6:	00 00 00 
  801fd9:	be 28 00 00 00       	mov    $0x28,%esi
  ...
  802070:	00 00 00 
  802073:	be 2d 00 00 00       	mov    $0x2d,%esi
  ...
  8020bf:	00 00 00 
  8020c2:	be 31 00 00 00       	mov    $0x31,%esi
...
duppage(envid_t envid, unsigned pn)
{
  ...
  802172:	00 00 00 
  802175:	be 50 00 00 00       	mov    $0x50,%esi
  ...
  8021da:	00 00 00 
  8021dd:	be 64 00 00 00       	mov    $0x64,%esi
  ...
  80223d:	00 00 00 
  802240:	be 66 00 00 00       	mov    $0x66,%esi
...
sys_exofork(void)
{
  ...
  8023d4:	00 00 00 
  8023d7:	be 9e 00 00 00       	mov    $0x9e,%esi
  ...
  802435:	00 00 00 
  802438:	be a2 00 00 00       	mov    $0xa2,%esi
  ...
  802484:	00 00 00 
  802487:	be a7 00 00 00       	mov    $0xa7,%esi
...
sfork(void)
{
  ...
  8024b8:	00 00 00 
  8024bb:	be b1 00 00 00       	mov    $0xb1,%esi
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  803056:	00 00 00 
  803059:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  803083:	48 b9 3d 52 80 00 00 	movabs $0x80523d,%rcx
  80308a:	00 00 00 
  80308d:	48 ba 1d 52 80 00 00 	movabs $0x80521d,%rdx
  803094:	00 00 00 
  803097:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80319b:	00 00 00 
  80319e:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  80336d:	48 bf 49 52 80 00 00 	movabs $0x805249,%rdi
  803374:	00 00 00 
  ...
  8033b9:	48 bf 5f 52 80 00 00 	movabs $0x80525f,%rdi
  8033c0:	00 00 00 
  ...
  80341e:	48 bf 79 52 80 00 00 	movabs $0x805279,%rdi
  803425:	00 00 00 
  ...
  80349b:	48 bf 8c 52 80 00 00 	movabs $0x80528c,%rdi
  8034a2:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80385b:	48 be a7 52 80 00 00 	movabs $0x8052a7,%rsi
  803862:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  803baa:	48 b9 ae 52 80 00 00 	movabs $0x8052ae,%rcx
  803bb1:	00 00 00 
  803bb4:	48 ba c3 52 80 00 00 	movabs $0x8052c3,%rdx
  803bbb:	00 00 00 
  803bbe:	be 62 00 00 00       	mov    $0x62,%esi
  803bc3:	48 bf d8 52 80 00 00 	movabs $0x8052d8,%rdi
  803bca:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  803c34:	48 b9 e4 52 80 00 00 	movabs $0x8052e4,%rcx
  803c3b:	00 00 00 
  803c3e:	48 ba c3 52 80 00 00 	movabs $0x8052c3,%rdx
  803c45:	00 00 00 
  803c48:	be 6d 00 00 00       	mov    $0x6d,%esi
  803c4d:	48 bf d8 52 80 00 00 	movabs $0x8052d8,%rdi
  803c54:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  803fae:	48 bf f5 52 80 00 00 	movabs $0x8052f5,%rdi
  803fb5:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  804232:	48 be 08 53 80 00 00 	movabs $0x805308,%rsi
  804239:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80456e:	48 be 14 53 80 00 00 	movabs $0x805314,%rsi
  804575:	00 00 00 
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8045d5:	48 ba 20 53 80 00 00 	movabs $0x805320,%rdx
  8045dc:	00 00 00 
  8045df:	be 22 00 00 00       	mov    $0x22,%esi
  8045e4:	48 bf 3f 53 80 00 00 	movabs $0x80533f,%rdi
  8045eb:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8047e0:	48 ba 4d 53 80 00 00 	movabs $0x80534d,%rdx
  8047e7:	00 00 00 
  8047ea:	be 47 00 00 00       	mov    $0x47,%esi
  8047ef:	48 bf 63 53 80 00 00 	movabs $0x805363,%rdi
  8047f6:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804951:	48 ba 4d 53 80 00 00 	movabs $0x80534d,%rdx
  804958:	00 00 00 
  80495b:	be 79 00 00 00       	mov    $0x79,%esi
  804960:	48 bf 63 53 80 00 00 	movabs $0x805363,%rdi
  804967:	00 00 00 
