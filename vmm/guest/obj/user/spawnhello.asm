...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  802805:	00 00 00 
  802808:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  802832:	48 b9 bd 52 80 00 00 	movabs $0x8052bd,%rcx
  802839:	00 00 00 
  80283c:	48 ba 9d 52 80 00 00 	movabs $0x80529d,%rdx
  802843:	00 00 00 
  802846:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80294a:	00 00 00 
  80294d:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  802b1c:	48 bf c9 52 80 00 00 	movabs $0x8052c9,%rdi
  802b23:	00 00 00 
  ...
  802b68:	48 bf df 52 80 00 00 	movabs $0x8052df,%rdi
  802b6f:	00 00 00 
  ...
  802bcd:	48 bf f9 52 80 00 00 	movabs $0x8052f9,%rdi
  802bd4:	00 00 00 
  ...
  802c4a:	48 bf 0c 53 80 00 00 	movabs $0x80530c,%rdi
  802c51:	00 00 00 
...
error:
  ...
  802f89:	48 ba 64 53 80 00 00 	movabs $0x805364,%rdx
  802f90:	00 00 00 
  ...
  802fd8:	48 ba 7e 53 80 00 00 	movabs $0x80537e,%rdx
  802fdf:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  803f4d:	48 b9 32 54 80 00 00 	movabs $0x805432,%rcx
  803f54:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8042c7:	48 bf 43 54 80 00 00 	movabs $0x805443,%rdi
  8042ce:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  804887:	48 be 62 54 80 00 00 	movabs $0x805462,%rsi
  80488e:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8049d1:	48 ba 69 54 80 00 00 	movabs $0x805469,%rdx
  8049d8:	00 00 00 
  8049db:	be 47 00 00 00       	mov    $0x47,%esi
  8049e0:	48 bf 7f 54 80 00 00 	movabs $0x80547f,%rdi
  8049e7:	00 00 00 
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  804b42:	48 ba 69 54 80 00 00 	movabs $0x805469,%rdx
  804b49:	00 00 00 
  804b4c:	be 79 00 00 00       	mov    $0x79,%esi
  804b51:	48 bf 7f 54 80 00 00 	movabs $0x80547f,%rdi
  804b58:	00 00 00 
