...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80124e:	00 00 00 
  801251:	be 86 00 00 00       	mov    $0x86,%esi
  ...
  80127b:	48 b9 85 41 80 00 00 	movabs $0x804185,%rcx
  801282:	00 00 00 
  801285:	48 ba 65 41 80 00 00 	movabs $0x804165,%rdx
  80128c:	00 00 00 
  80128f:	be 87 00 00 00       	mov    $0x87,%esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801393:	00 00 00 
  801396:	be a2 00 00 00       	mov    $0xa2,%esi
...
copy(char *src, char *dest)
{
  ...
  801565:	48 bf 91 41 80 00 00 	movabs $0x804191,%rdi
  80156c:	00 00 00 
  ...
  8015b1:	48 bf a7 41 80 00 00 	movabs $0x8041a7,%rdi
  8015b8:	00 00 00 
  ...
  801616:	48 bf c1 41 80 00 00 	movabs $0x8041c1,%rdi
  80161d:	00 00 00 
  ...
  801693:	48 bf d4 41 80 00 00 	movabs $0x8041d4,%rdi
  80169a:	00 00 00 
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a53:	48 be ef 41 80 00 00 	movabs $0x8041ef,%rsi
  801a5a:	00 00 00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801da2:	48 b9 f6 41 80 00 00 	movabs $0x8041f6,%rcx
  801da9:	00 00 00 
  801dac:	48 ba 0b 42 80 00 00 	movabs $0x80420b,%rdx
  801db3:	00 00 00 
  801db6:	be 62 00 00 00       	mov    $0x62,%esi
  801dbb:	48 bf 20 42 80 00 00 	movabs $0x804220,%rdi
  801dc2:	00 00 00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801e2c:	48 b9 2c 42 80 00 00 	movabs $0x80422c,%rcx
  801e33:	00 00 00 
  801e36:	48 ba 0b 42 80 00 00 	movabs $0x80420b,%rdx
  801e3d:	00 00 00 
  801e40:	be 6d 00 00 00       	mov    $0x6d,%esi
  801e45:	48 bf 20 42 80 00 00 	movabs $0x804220,%rdi
  801e4c:	00 00 00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8021a6:	48 bf 3d 42 80 00 00 	movabs $0x80423d,%rdi
  8021ad:	00 00 00 
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80242a:	48 be 50 42 80 00 00 	movabs $0x804250,%rsi
  802431:	00 00 00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802766:	48 be 5c 42 80 00 00 	movabs $0x80425c,%rsi
  80276d:	00 00 00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802840:	48 bf 68 42 80 00 00 	movabs $0x804268,%rdi
  802847:	00 00 00 
  ...
  80287a:	ff d0                	callq  *%rax
	cprintf("\n");
  80287c:	48 bf 8b 42 80 00 00 	movabs $0x80428b,%rdi
  802883:	00 00 00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  803dfe:	00 00 00 
  803e01:	be 47 00 00 00       	mov    $0x47,%esi
...
ipc_host_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  803f6f:	00 00 00 
  803f72:	be 79 00 00 00       	mov    $0x79,%esi
