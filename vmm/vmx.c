...
bool vmx_check_ept() {
	/* Your code here */
#define SECONDARY_VMX_CONTROL_BIT 63
#define ENABLE_EPT_BIT 33
    return BIT(read_msr(IA32_VMX_PROCBASED_CTLS), SECONDARY_VMX_CONTROL_BIT) && \
        BIT(read_msr(IA32_VMX_PROCBASED_CTLS2), ENABLE_EPT_BIT);
}
